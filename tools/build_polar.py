...
def chart_cheatsheet(v, up, m, heel_fast, floor, power, held, cal, hours, outdir, plt):
    ...
    fig = plt.figure(figsize=(11, 36.37))
    fig.patch.set_facecolor(SURFACE)
    ax = fig.add_axes([0, 0, 1, 1]); ax.axis('off'); ax.set_xlim(0, 100); ax.set_ylim(-130.7, 200)
    ...
    T(5, -128.6, 'Generated by tools/build_polar.py — docs/polar.md has the method and caveats.', fontsize=8, color=INK2)
